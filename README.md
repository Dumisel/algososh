# МБОУ АЛГОСОШ им. Фибоначчи. Проектная работа для Яндекс.Практикума.
---

Работа над проектом велась в два этапа:

+ 1 месяц - разработка визуализации алгоритмов
+ 2 месяц - тестирование рааботы компонентов при помощи технологий Jest и Cypress

Проект реализован на шаблоне Яндекс.Практикума и направлен на понимание принципов работы основных алгоритмов сортировки и их визуализации:

## Строка

На этом экране вам предстоит развернуть строку.
